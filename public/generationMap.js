const svg = d3.select("#my_dataviz_2"),
...
Promise.all([
    ...
    d3.csv("https://raw.githubusercontent.com/chintseng/my_csv_file/master/enrgy_data/State%20Electricity%20Profiles_"+selectYear+".csv", function(d) {
        data.set(d.iso3166_2, d['Net generation (MWh)'])
    })
  ...
  .interpolator(d3.interpolateGnBu);
    ...
    var mouseover = function(event, d) {
      Tooltip
          .html("State: " +  d.properties.google_name + "<br/>Net generation (MWh): " + separator(data.get(d.properties.iso3166_2)))
          .style("opacity", 1)
    }
